...
public class MovieDAO {
    ...
    private static final String INSERT_SQL = 
            ...
            + "  VALUES (:title, :isrented, :releasedate, :pricecategory, :agerating)";
    /** SQL statement to update movie. */
    private static final String UPDATE_SQL = "UPDATE movies "
            + "SET title = :title, isrented = :isrented, "
    ...
    private static final String GET_ALL_RENTED_SQL = SELECT_CLAUSE + " WHERE isrented = :isrented";
	...
	private Query prepareQuery(Connection conn, String sql, Movie m) {
		return conn.createQuery(sql)
				...
				.addParameter("isrented", m.isRented())
